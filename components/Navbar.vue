...
<template>
  <nav class="fixed left-50% top-0 z-99 h-15 w-full flex items-center justify-between px-5 max-w-8xl sm:h-20 -translate-x-50% md:px-8">
    <Logo />
    <ul class="flex items-center justify-between gap-x-2 list-none sm:gap-x-3">
